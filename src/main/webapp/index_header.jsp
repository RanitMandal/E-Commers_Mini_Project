      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            <li class="myaccount"><a href='<%= (str != null) ? "#" : "user_login.jsp" %>'><span>My Account</span></a></li>
            <li class="wishlist"><a href='<%= (str != null) ? "#" : "user_login.jsp" %>'><span>Wishlist</span></a></li>
            <li class="header_cart hidden-xs"><a href='<%= (str != null) ? "#" : "user_login.jsp" %>'><span>My Cart</span></a></li>
            <li class="check"><a href='<%= (str != null) ? "#" : "user_login.jsp" %>'><span>Checkout</span></a></li>
            <li class='nav-item'>
            <%= (str != null) ? "<a href='UserLogout'><span>Logout</span></a>" : "<a href='user_login.jsp'><span>Login</span></a>" %>
            </li>
